 ...
 * WARNING: These functions/definition are unsafe so take care when you use them. They give you free
 * 			access to privileged data of FreeRTOS.
 ***************************************************************************************************/
#ifdef configFIE_ENABLED
	#if ( configFIE_ENABLED == 1 )
	/*
	...
	typedef tskTCB FIE_TCB_t;
	typedef List_t FIE_List_t;

	FIE_List_t *pxFIEGetReadyTasksHandle( void )        PRIVILEGED_FUNCTION;
	FIE_List_t *pxFIEGetDelayedTasksHandle( void )      PRIVILEGED_FUNCTION;
	FIE_List_t *pxFIEGetOvfDelayedTasksHandle( void )   PRIVILEGED_FUNCTION;
	FIE_List_t *pxFIEGetSuspendedTasksHandle( void )    PRIVILEGED_FUNCTION;
	FIE_TCB_t  *pxFIEGetCurrentTCBHandle( void )        PRIVILEGED_FUNCTION;
	FIE_TCB_t  *pxFIEGetIdleTCBHandle( void )			PRIVILEGED_FUNCTION;
