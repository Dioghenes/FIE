...
volatile TickType_t xTickCount 				= ( TickType_t ) 0U;
volatile UBaseType_t uxTopReadyPriority 	= tskIDLE_PRIORITY;
volatile BaseType_t xSchedulerRunning 		= pdFALSE;
volatile UBaseType_t uxPendedTicks 			= ( UBaseType_t ) 0U;
volatile BaseType_t xYieldPending 			= pdFALSE;
volatile BaseType_t xNumOfOverflows 		= ( BaseType_t ) 0;
UBaseType_t uxTaskNumber 					= ( UBaseType_t ) 0U;
volatile TickType_t xNextTaskUnblockTime	= ( TickType_t ) 0U;
TaskHandle_t xIdleTaskHandle				= NULL;
volatile UBaseType_t uxSchedulerSuspended	= ( UBaseType_t ) pdFALSE;
#endif
...
/***************************************************************************************************
 * !!!FAULT INJECTION ENVIRONMENT !!!
 * WARNING: They are unsafe so take care when you use them. They give you free
 * 			access to privileged data of FreeRTOS
 ***************************************************************************************************/
#ifdef configFIE_ENABLED
	#if ( configFIE_ENABLED == 1 )

	FIE_List_t *pxFIEGetReadyTasksHandle( void ) {return (FIE_List_t*)pxReadyTasksLists;}

	FIE_List_t *pxFIEGetDelayedTasksHandle( void ) {return (FIE_List_t*)&xDelayedTaskList1;}

	FIE_List_t *pxFIEGetOvfDelayedTasksHandle( void ) {return (FIE_List_t*)&xDelayedTaskList2;}

	FIE_List_t *pxFIEGetSuspendedTasksHandle( void ) {return (FIE_List_t*)&xSuspendedTaskList;}

	FIE_TCB_t *pxFIEGetCurrentTCBHandle( void ) {return (FIE_TCB_t*)pxCurrentTCB;}

	FIE_TCB_t *pxFIEGetIdleTCBHandle( void ) {return (FIE_TCB_t*)xIdleTaskHandle;}
